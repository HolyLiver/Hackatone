# -*- coding: utf-8 -*-
"""Optuna22091334.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1HPh4LgEyiWZmOhMIkjwiMzE9GbGIqxJG
"""
...
preparing_to_optuna("train_mordred_desc795_smote_date20_09_time12.csv", list(pd.read_csv('select_features.csv')['features']))

def preparing_to_optuna(path,features):
  df = pd.read_csv(path)
  y = df['Y']
  X = df.loc[:, features]
  return y, X
